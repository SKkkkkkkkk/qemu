...
enum {
    CPU_45_SERIES_IOPMP_APB,
    CPU_45_SERIES_IOPMP_RAM,
    CPU_45_SERIES_IOPMP_SLP,
    CPU_45_SERIES_IOPMP_ROM,
    CPU_45_SERIES_IOPMP_IOCP, /* not impl */
    CPU_45_SERIES_IOPMP_DFS /* not impl */
};

enum {
    CPU_23_SERIES_IOPMP_AHB,
    CPU_23_SERIES_IOPMP_RAM,
    CPU_23_SERIES_IOPMP_ROM,
    CPU_23_SERIES_IOPMP_ILMAP,
    CPU_23_SERIES_IOPMP_DLMAP
};

enum {
    IOPMP100_PORT_SMU = 1,
    IOPMP100_PORT_UART1 = 2,
    IOPMP100_PORT_UART2 = 3,
    IOPMP100_PORT_PIT = 4,
    IOPMP100_PORT_WDT = 5,
    IOPMP100_PORT_RTC = 6,
    IOPMP100_PORT_GPIO = 7,
    IOPMP100_PORT_I2C = 8,
    IOPMP100_PORT_SPI1 = 9,
    IOPMP100_PORT_SPI2 = 10,
    IOPMP100_PORT_SDC = 11,
    IOPMP100_PORT_DMAC = 12,
    IOPMP100_PORT_SSP = 13,
    IOPMP100_PORT_DTROM = 14,
    IOPMP100_PORT_IOPMP = 15,
    IOPMP100_PORT_ABPBRG_APBDEC = 16,
    IOPMP100_PORT_NUM,
};

enum {
    ANDES_SECURE_PLATFORM_NONE = 0,
    ANDES_SECURE_PLATFORM_CPU_23_SERIES = 23,
